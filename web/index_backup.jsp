...
<html>
    ...
    <body>
        ...
        <div>
                First name: <input  name="AnalistaNombreTxt" id="AnalistaNombreTxt">
                <br>
                Last name: <input  name="AnalistaApellidoTxt" id="AnalistaApellidoTxt">
                <br>
                User: <input  name="AnalistaUsuarioTxt" id="AnalistaUsuarioTxt">
                <br>
                Password: <input  name="AnalistaPasswordTxt" id="AnalistaPasswordTxt">
                <br>
                <br>
